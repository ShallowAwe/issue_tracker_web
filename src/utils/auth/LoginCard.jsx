  ...
  return (
    <div className="w-full max-w-md px-6">
      <div className="relative group">
        {/* Enhanced Glow */}
        <div className="absolute -inset-2 bg-linear-to-r from-indigo-500/20 via-purple-500/20 to-pink-500/20 rounded-3xl blur-3xl opacity-50 group-hover:opacity-70 transition duration-1000"></div>
        ...
        <div className="relative backdrop-blur-xl bg-white/40 border border-white/60 shadow-2xl rounded-3xl p-10 overflow-hidden transition-all duration-500">
          {/* Gradient Overlays */}
          <div className="absolute -top-32 -right-32 w-64 h-64 bg-linear-to-br from-indigo-400/20 to-purple-400/20 rounded-full blur-3xl"></div>
          <div className="absolute -bottom-32 -left-32 w-64 h-64 bg-linear-to-tr from-purple-400/20 to-pink-400/20 rounded-full blur-3xl"></div>

          {/* Header */}
          <div className="relative mb-10 text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-linear-to-br from-indigo-500 to-indigo-700 rounded-2xl mb-5 shadow-xl shadow-indigo-500/30 rotate-3 group-hover:rotate-0 transition-transform duration-500">
          ...
          <div className="relative space-y-5">
            ...
            <button
              ...
              className="group relative w-full py-4 mt-6 bg-linear-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 text-white font-bold rounded-xl shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/40 active:scale-[0.98] transition-all duration-200 overflow-hidden"
            >
          ...
          <div className="mt-10 flex flex-col items-center gap-4">
            <div className="h-px w-16 bg-linear-to-r from-transparent via-gray-300 to-transparent"></div>
